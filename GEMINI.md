...
For the detailed workflow of the Dev Request Service, please refer to [CORE_SERVICE_WORKFLOWS.md](docs/CORE_SERVICE_WORKFLOWS.md).

#### TODO:
- [ ] Add Architecture descriptions (therefore also compare the "Building the Services" section in Jira task COP-114)
