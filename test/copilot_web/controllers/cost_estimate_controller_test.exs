defmodule CopilotWeb.CostEstimateControllerTest do
  ...
  describe "create" do
    ...
    test "creates a cost estimate for a developer", %{conn: conn, owner_customer: owner_customer} do
      ...
      cost_estimate = Copilot.Core.CostEstimates.get_cost_estimate!(id)
  ...
  describe "delete" do
    ...
    test "deletes cost estimate for developer", %{conn: conn, cost_estimate: cost_estimate} do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Copilot.Core.CostEstimates.get_cost_estimate!(cost_estimate.id)
      end
    end
  end
end
