defmodule CopilotWeb.AIAnalysisControllerTest do
  ...
  describe "create" do
    ...
    test "creates an analysis for a developer", %{conn: conn} do
      ...
      analysis = Copilot.Core.AIAnalyses.get_ai_analysis!(id)
  ...
  describe "delete" do
    ...
    test "deletes analysis for developer", %{conn: conn, analysis: analysis} do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Copilot.Core.AIAnalyses.get_ai_analysis!(analysis.id)
      end
    end
  end
end
