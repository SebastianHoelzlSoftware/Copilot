defmodule PentoWeb.CoreComponents do
  ...
  @doc """
  Renders a special red button.

  ## Examples

      <.red_button>Send!</.red_button>
      <.red_button phx-click="go" class="ml-2">Send!</.red_button>
  """
  attr :type, :string, default: nil
  attr :class, :string, default: nil
  attr :rest, :global, include: ~w(disabled form name value)
  ...
  @doc """
  Renders an animated Processing button.

  ## Examples

      <.processing_button>Send!</.processing_button>
      <.processing_button phx-click="go" class="ml-2">Processing...</.processing_button>
  """
  attr :type, :string, default: nil
  attr :class, :string, default: nil
  attr :rest, :global, include: ~w(disabled form name value)
  ...
  def processing_button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "inline-flex cursor-not-allowed items-center rounded-md bg-indigo-500 px-4 py-2 ",
        "text-sm leading-6 font-semibold text-white transition duration-150 ease-in-out hover:bg-indigo-400",
        @class
      ]}
      @rest
    >
